...
const Header: React.FC<HeaderProps> = ({ pageTitle, pageDescription }) => {
  ...
  const showSearch = activePage === 'products';
        ...
        {user && (
          <div className="relative w-full sm:w-auto" ref={dropdownRef}>
            <button 
              ...
              className="flex items-center space-x-2 p-2 rounded-lg cursor-pointer hover:bg-gray-200 transition-colors w-full border border-transparent hover:border-gray-200"
            >
              <img 
